...
namespace Tetris.Game.Tetriminoes
{
    ...
    /// <summary>
    /// Tetromino I class. I tetromino is a 5*5 matrix
    /// </summary>
    internal class ITetrominoExtra : Tetromino
    {
        ...
        public ITetrominoExtra(Deck deck) : base(deck, 5) { }
        ...
        protected override void SpecifyVisibleBlocks()
        {
            ...
            */
            ...
            Blocks[5].Status = BlockStatus.Salmon;
            Blocks[6].Status = BlockStatus.Salmon;
            Blocks[7].Status = BlockStatus.Salmon;
            Blocks[8].Status = BlockStatus.Salmon;
            Blocks[9].Status = BlockStatus.Salmon;
        }
