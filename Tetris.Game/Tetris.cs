...
namespace Tetris.Game
{
    ...
    public class Tetris
    {
        ...
        /// </summary>
        private readonly int lockDelayInterval = 100;
        ...
        private void InitilizeTetrominoHandler()
        {
            ...
            var initialResult = tetrominoHandler.Initialize(scoreManagement, Difficulty);
        ...
        private bool MoveDownInternal(bool hardDrop)
        {
            ...
            var moveDownResult = tetrominoHandler.MoveDown(Difficulty);
        ...
        public Tetris(int deckWidth, int deckHeight, string Difficulty)
        {
        ...
        public void Hold()
        {
            ...
            lock (synchronizationToken)
            {
                var holdResult = tetrominoHandler.Hold(scoreManagement);
